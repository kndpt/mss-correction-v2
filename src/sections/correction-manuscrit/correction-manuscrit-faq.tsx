        ...
        >
          ...
          <m.div variants={varFade().inDown}>
            <Typography sx={{ color: 'text.secondary', pb: 12, pt: 4 }}>
              Ce service de correction de manuscrit offre la tranquillité d&apos;esprit, sachant que
              les aspects linguistiques de votre œuvre sont entre des mains expertes.
            </Typography>
          </m.div>
          <div>
