...
export const priceMultiplierForBeautification = 1.70;
export const timeMultiplierForBeautification = 1.40;
export const maxWordsFor24Hours = 50000;
export const maxWordsFor2Days = 100000;
export const maxWordsFor3Days = 150000;
