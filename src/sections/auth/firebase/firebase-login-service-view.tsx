...
interface Props {
  handleCreateAccountView: () => void;
}

// ----------------------------------------------------------------------

export default function FirebaseLoginServiceView({ handleCreateAccountView }: Props) {
  ...
  const renderHead = (
    <Stack spacing={2} sx={{ mb: 5 }}>
      ...
      <Stack direction="row" spacing={0.5}>
        ...
        <Link variant="subtitle2" onClick={handleCreateAccountView}>
          Créer un compte
        </Link>
      </Stack>
    </Stack>
