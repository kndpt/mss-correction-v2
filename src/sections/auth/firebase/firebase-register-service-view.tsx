...
interface Props {
  handleSignInAccountView: () => void;
}

// ----------------------------------------------------------------------

export default function FirebaseRegisterServiceView({ handleSignInAccountView }: Props) {
  ...
  const renderHead = (
    <Stack spacing={2} sx={{ mb: 5, position: 'relative' }}>
      ...
      <Stack direction="row" spacing={0.5}>
        ...
        <Link variant="subtitle2" onClick={handleSignInAccountView}>
          Se connecter
        </Link>
      </Stack>
    </Stack>
