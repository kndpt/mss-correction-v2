...
import ServicePendingOrdersAlert from './components/service-pending-orders-alert';
        ...
        <FirestoreOrdersProvider>
          ...
          >
            ...
            <m.div variants={varFade().inDown}>
              ...
              >
                Téléchargez votre manuscrit pour une estimation personnalisée. Aucun fichier
                n&apos;est partagé ou utilisé sans votre consentement.
              </Typography>
            </m.div>
          </Stack>

          <Container maxWidth={settings.themeStretch ? false : 'lg'} sx={{ mb: 10 }}>
            <ServicePendingOrdersAlert />
            <ServiceStepper />
          </Container>
        </FirestoreOrdersProvider>
      </FirebaseStorageProvider>
