...
export const OPTIONS = [
  { checked: true, label: 'Correction orthographique adaptée à votre manuscrit' },
  ...
  { checked: true, label: 'Relecture complète pour la cohérence de votre manuscrit' },
  { checked: true, label: 'Reformulation des phrases floues ou maladroites' },
];

// ----------------------------------------------------------------------

export default function CorrectionManuscritBefenits() {
  ...
  return (
    ...
    >
      ...
      <Stack spacing={3} sx={{ textAlign: 'center' }}>
        <m.div variants={varFade().inDown}>
          <Typography variant="h2">Quelques avantages pour votre manuscrit</Typography>
        </m.div>
