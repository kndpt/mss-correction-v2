...
export default function CorrectionManuscritHeroV2() {
  const renderRatings = (
    <MInview>
      <Box
        gap={1.5}
  ...
  const renderDescription = (
    ...
    >
      <m.div variants={varFade().inDown}>
        ...
        >
          Sublimez votre manuscrit et révélez tout son potentiel
        </Typography>
      </m.div>
      ...
      <m.div variants={varFade().inDown}>
        ...
        >
          Chaque faute est traquée avec précision. J&apos;améliore la fluidité, le style et
          l&apos;impact de votre manuscrit pour offrir une lecture professionnelle et captivante.{' '}
          <br />
          Même si c&apos;est votre tout premier projet. 🙂
        </Typography>
      </m.div>
