...
const CATEGORIES = [
  ...
  {
    label: 'Discutons ensemble pour un résultat optimal',
    icon: '/assets/icons/faqs/ic_assurances.svg',
    href: '#',
  },
  {
    label: 'Obtenez votre texte revu et perfectionné',
  ...
  const renderDescription = (
    <Stack spacing={3} sx={{ textAlign: 'center' }}>
      <m.div variants={varFade().inDown}>
        <Typography variant="h2">Les étapes de la correction</Typography>
      </m.div>
